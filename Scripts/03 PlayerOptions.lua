...
function OptionRowJudgmentGraphic()
	local t = {
		...
		Choices = {"Legacy", "Bebas", "Zona", "Mikado", "Discord", "Monokai", "Japanese", "Sushi Violation", "Sushi", "Love", "Groove", "Xtreme", "Ace", "Twenty", "Poppin’", "Deluxe", "Infinity", "Coaster", "Just", "Super", "None"},
		--Embedded in the metatable because the ScreenSelectMusic needs to access it too
		judgementFileNames = { "Season1", "Season2", "Zona", "Mikado", "Discord", "Monokai", "Japanese", "SushiViolation", "Sushi", "Love", "Groove", "Extreme", "Ace", "A20", "Poppin", "Deluxe", "Infinity", "Coaster", "Just", "Super", "None"},
		LoadSelections = function(self, list, pn)
			local found = false;
			for i=1,#list do
